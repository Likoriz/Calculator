...
bool operator ==(BigInteger& left, BigInteger& right) {
	...
	// поскольку у нас два представлени€ нул€, нужно это особо обработать
	...
	// так как у нас нет ведущих нулей, то в числах должно быть одинаковое количество цифр (разр€дов)
